...
function showModal(content="", title="提示", callback=null) {
  ...
  modal.id = "modal_" + timestamp;
  modal.setAttribute("data-status", "hidden");
  modal.onclick = (event) =>{toggleModal(event, "modal_" + timestamp)};
